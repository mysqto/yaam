...
and the fan-out it queues writes them again from the tree, which the same command then drains. The key store is the load-bearing exclusion — erasure works by
