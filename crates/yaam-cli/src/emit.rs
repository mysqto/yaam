...
//! binary's word for it: see [`crate::cli::FileCli`] for the three refusals behind this one, one of
//! which is the store's own posture rather than a permission about a caller.
//!
